...
class FormularioNuevoVehiculo(forms.ModelForm):
    class Meta:
        model = Vehiculo
        fields = ('usuario', 'titulo', 'vehiculo', 'marca', 'modelo', 'descripcion', 'year', 'precio', 'telefonoContacto', 'emailContacto', 'imagenInstrumento')
...
class ActualizacionVehiculo(forms.ModelForm):
    class Meta:
        model = Vehiculo
        fields = ('titulo', 'vehiculo', 'marca', 'modelo', 'descripcion', 'year', 'precio', 'telefonoContacto', 'emailContacto', 'imagenInstrumento')
